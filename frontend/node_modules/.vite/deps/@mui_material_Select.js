...
import {
>>>>>>> 5a8e0992d26ffa3fac997b8d2d7b0aa1f78a4a48
  formControlState
} from "./chunk-PR6ZCO7G.js";
import {
  isFilled
} from "./chunk-PY4HL7MF.js";
import {
...
} from "./chunk-6B55AG62.js";
import "./chunk-L4GSZX2I.js";
import {
  useEnhancedEffect_default as useEnhancedEffect_default2,
  useForkRef_default
} from "./chunk-3FP4MUQW.js";
import {
  memoTheme_default
} from "./chunk-4BYFCU2O.js";
import {
  capitalize_default,
  globalCss,
  useDefaultProps
} from "./chunk-PBG7V5JE.js";
import {
  HTMLElementType,
  alpha,
  chainPropTypes,
...
var TextareaAutosize = React16.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsxs)(React16.Fragment, {
    children: [(0, import_jsx_runtime14.jsx)("textarea", {
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
      style,
      ...other
    }), (0, import_jsx_runtime14.jsx)("textarea", {
      "aria-hidden": true,
...
var InputBase = React17.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React17.Fragment, {
    ...
    (_InputGlobalStyles || (_InputGlobalStyles = (0, import_jsx_runtime15.jsx)(InputGlobalStyles, {}))), (0, import_jsx_runtime15.jsxs)(Root, {
      ...rootProps,
      ref,
      onClick: handleClick,
      ...other,
      ...
      children: [startAdornment, (0, import_jsx_runtime15.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime15.jsx)(Input3, {
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(NotchedOutlineRoot, {
    "aria-hidden": true,
    className,
    ownerState,
    ...other,
    children: (0, import_jsx_runtime18.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime18.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span2 || (_span2 = (0, import_jsx_runtime18.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
...
true ? NotchedOutline.propTypes = {
   ...
   */
  notched: import_prop_types18.default.bool.isRequired,
  /**
   * @ignore
   */
...
var OutlinedInput = React21.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime19.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime19.jsxs)(React21.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
true ? OutlinedInput.propTypes = {
   ...
   * If `true`, the outline is notched to accommodate the label.
   */
  notched: import_prop_types19.default.bool,
  /**
   * Callback fired when the value is changed.
   *
   * @param {React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>} event The event source of the callback.

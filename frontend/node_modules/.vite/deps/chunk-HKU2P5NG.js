...
var Popover = React10.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(RootSlot, {
    ...
    ...other,
    ref,
    children: (0, import_jsx_runtime8.jsx)(TransitionComponent, {
      appear: true,
      in: open,
      onEntering: handleEntering,
      onExited: handleExited,
...
var Menu = React11.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(MenuRoot, {
    ...
    children: (0, import_jsx_runtime9.jsx)(MenuMenuList, {
...
var TextareaAutosize = React15.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React15.useRef(null);
  const hiddenTextareaRef = React15.useRef(null);
  const calculateTextareaStyles = React15.useCallback(() => {
  ...
  const frameRef = React15.useRef(-1);
  useEnhancedEffect_default(() => {
...
var InputBase = React16.forwardRef(function InputBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInputBase"
  });
  ...
  const checkDirty = React16.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
...
var Input = React17.forwardRef(function Input2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInput"
  });
...
var FilledInput = React18.forwardRef(function FilledInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFilledInput"
  });
...
var OutlinedInput = React20.forwardRef(function OutlinedInput2(inProps, ref) {
  var _React$Fragment;
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  ...
  return (0, import_jsx_runtime18.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime18.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime18.jsxs)(React20.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HKU2P5NG.js.map

...
INSERT INTO `membership` (`membership_id`, `plan_name`, `description`, `price`) VALUES
(1, 'Standard Monthly', 'Basic access to gym facilities, group classes, and locker rooms for one month.', 30.00),
(2, 'Premium Monthly', 'Includes all Standard features, plus a dedicated personal trainer for personalized guidance.', 50.00),
(3, 'Standard Yearly', 'Discounted annual plan with basic access to gym facilities, group classes, and locker rooms.', 300.00),
(4, 'Premium Yearly', 'Includes all Standard Yearly features, plus a dedicated personal trainer for the entire year.', 500.00);
...
(1, 7, 'Standard Monthly Membership - January 2025', 30.00, 'Completed', '2025-01-05'),
(2, 2, 'Premium Monthly Membership - January 2025', 50.00, 'Completed', '2025-01-06'),
(3, 9, 'Standard Yearly Membership - 2025', 300.00, 'Completed', '2025-01-07'),
(4, 4, 'Premium Yearly Membership - 2025', 500.00, 'Completed', '2025-01-08');

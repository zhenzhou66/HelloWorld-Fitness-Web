...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2025 at 12:47 PM
...
INSERT INTO `notifications` (`notification_id`, `title`, `message`, `type`, `send_date`) VALUES
(1, 'Class Schedule Update', 'The Zumba class on Friday has been rescheduled to 5:00 PM.', 'Announcement', '2025-01-14 10:00:00'),
(2, 'Membership Renewal Reminder', 'Your membership is set to expire soon. Renew now to avoid interruptions.', 'Reminder', '2025-01-10 08:00:00'),
(3, 'Class Reminder', 'Don’t forget your Yoga class tomorrow at 7:00 AM.', 'Reminder', '2025-01-12 18:00:00');
...
(2, 2, 'Premium Monthly - January 2025', 50.00, 'Overdue', '2025-01-06'),
(3, 9, 'Standard Yearly - 2025', 300.00, 'Pending', '2025-01-07'),
...
CREATE TABLE `workout_details` (
  ...
  `rest_time_seconds` int(11) DEFAULT NULL,
  `duration_minutes` decimal(5,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(4, 'Jump Rope', 'Cardio', NULL, NULL, NULL, 10.00),
...
(9, 'Plank', 'Core', NULL, NULL, NULL, 2.00),
(10, 'Cycling', 'Cardio', NULL, NULL, NULL, 20.00),
...
(16, 'Side Plank', 'Core', NULL, NULL, NULL, 1.50),
(17, 'Running', 'Cardio', NULL, NULL, NULL, 25.00),
...
INSERT INTO `workout_plans` (`workout_plan_id`, `plan_name`, `description`, `difficulty`, `workout_image`) VALUES
(1, 'Beginner Strength Training', 'A basic strength training program for beginners.', 'Beginner', 'workout_image/1.webp'),
(2, 'Intermediate Fat Burn', 'A cardio and strength mix for fat loss.', 'Intermediate', 'workout_image/2.jpg'),
(3, 'Advanced Muscle Building', 'An advanced plan focused on muscle hypertrophy.', 'Advanced', 'workout_image/3.webp'),
(4, 'Full-Body Fitness', 'A full-body workout program to improve overall fitness.', 'Beginner', 'workout_image/4.jpg'),
(5, 'Endurance Booster', 'Cardio-focused workouts for improving endurance.', 'Intermediate', 'workout_image/5.jpg'),
(6, 'Core and Stability Training', 'Focused on core strength and stability exercises.', 'Advanced', 'workout_image/6.webp');
...
ALTER TABLE `attendance_classes`
  ...
  ADD KEY `attendance_classes_ibfk_1` (`user_id`),
  ADD KEY `attendance_classes_ibfk_2` (`class_id`);
...
ALTER TABLE `attendance_gym`
  ...
  ADD KEY `attendance_gym_ibfk_1` (`user_id`);
...
ALTER TABLE `classes`
  ...
  ADD KEY `classes_ibfk_1` (`trainer_id`);
...
ALTER TABLE `class_participants`
  ...
  ADD KEY `class_participants_ibfk_1` (`class_id`),
  ADD KEY `class_participants_ibfk_2` (`user_id`);
...
ALTER TABLE `feedback`
  ...
  ADD KEY `feedback_ibfk_1` (`member_id`),
  ADD KEY `feedback_ibfk_2` (`trainer_id`),
  ADD KEY `feedback_ibfk_3` (`class_id`);
...
ALTER TABLE `member_performance_feedback`
  ...
  ADD KEY `member_performance_feedback_ibfk_1` (`member_id`),
  ADD KEY `member_performance_feedback_ibfk_2` (`trainer_id`);
...
ALTER TABLE `user_badge`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_badge_ibfk_1` (`user_id`),
  ADD KEY `user_badge_ibfk_2` (`badge_id`);
...
ALTER TABLE `user_meal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_meal_ibfk_1` (`user_id`),
  ADD KEY `user_meal_ibfk_2` (`meal_id`);
...
ALTER TABLE `user_membership`
  ...
  ADD KEY `user_membership_ibfk_2` (`user_id`);
...
ALTER TABLE `user_workout_plans`
  ...
  ADD KEY `user_workout_plans_ibfk_1` (`user_id`),
  ADD KEY `user_workout_plans_ibfk_2` (`workout_plan_id`),
  ADD KEY `user_workout_plans_ibfk_3` (`trainer_id`);
...
ALTER TABLE `user_workout_progress`
  ADD PRIMARY KEY (`progress_id`),
  ADD KEY `user_workout_progress_ibfk_1` (`user_workout_id`),
  ADD KEY `user_workout_progress_ibfk_2` (`workout_detail_id`);
...
ALTER TABLE `workout_plan_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `workout_plan_details_ibfk_1` (`workout_detail_id`),
  ADD KEY `workout_plan_details_ibfk_2` (`workout_plan_id`);
...
--
ALTER TABLE `member_performance_feedback`
  ADD CONSTRAINT `member_performance_feedback_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `user` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
ALTER TABLE `user_meal`
  ADD CONSTRAINT `user_meal_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `user_meal_ibfk_2` FOREIGN KEY (`meal_id`) REFERENCES `meal` (`meal_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `user_workout_progress`
  ...
  ADD CONSTRAINT `user_workout_progress_ibfk_2` FOREIGN KEY (`workout_detail_id`) REFERENCES `workout_details` (`workout_detail_id`) ON DELETE SET NULL ON UPDATE CASCADE;

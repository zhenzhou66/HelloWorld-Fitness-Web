...
--
-- Host: localhost
-- Generation Time: Apr 10, 2025 at 03:44 PM
...
(3, '608', '2025-04-10 13:27:58', '2025-04-10 23:59:59', NULL),
(4, '593', '2025-04-10 21:39:12', '2025-04-10 22:39:12', 7);
...
(1, 'Yoga Flow', 'A relaxing yoga session focused on flexibility and mindfulness.', 20, '2025-04-07', '08:00:00', '09:00:00', 1, 'class_image/1.jpg'),
(2, 'Zumba Dance', 'High-energy dance workout to improve cardiovascular fitness.', 25, '2025-04-07', '10:00:00', '11:00:00', 5, 'class_image/2.jpeg'),
(3, 'Strength Training', 'Build muscle strength through resistance training and weightlifting.', 15, '2025-04-08', '15:00:00', '16:30:00', 8, 'class_image/3.webp'),
(4, 'Cardio Blast', 'A dynamic cardio session to burn calories and boost endurance.', 20, '2025-04-09', '18:00:00', '19:00:00', 5, 'class_image/4.jpg'),
(5, 'Pilates Core', 'Focused on improving core strength, posture, and flexibility using Pilates.', 18, '2025-04-09', '07:30:00', '08:30:00', 8, 'class_image/5.jpg'),
(6, 'Functional Fitness', 'Improve everyday movements through functional strength and agility exercises.', 15, '2025-04-10', '17:00:00', '18:30:00', 1, 'class_image/6.jpg'),
(7, 'HIIT', 'High-Intensity Interval Training session for maximum calorie burn in less time.', 20, '2025-04-11', '15:00:00', '16:45:00', 1, 'class_image/7.jpg'),
(8, 'Boxing Basics', 'A beginner-friendly boxing class focusing on technique and fitness.', 12, '2025-04-11', '19:00:00', '20:00:00', 1, 'class_image/8.webp');
...
(3, 1, '2025-04-10', 'Overly impressed by your progress. Keep it up!', 'You can strengthen more on your leg muscles by doing more sets of the workout plan.', 'Good first try. Keep up the good work!', 1);
...
(3, 'Class Reminder', 'Don’t forget your Bosing Basics class tomorrow at 7:00 PM.', 'Reminder', '2025-04-10 00:00:00', 'General', NULL, 8, '2025-04-11');
...
(40, 2, 'attendance', 10, '2025-04-10'),
(41, 2, 'workout', 3, '2025-04-10');
...
(2, 'sarahh', 'member', 'Sarah Jones', 'Female', 'sarah@hotmail.com', 'sa', '014-2312312', '2003-08-17', 'profile_pictures/2.jpg', '155.0', '50.0', 'Muscle Mass Gain', '2025-01-10'),
...
(11, 'test member', 'member', 'test', 'Female', 'test@gmail.com', 'test', '014-2312312', '2005-02-12', NULL, '170.0', '50.0', 'Gain Weight', '2025-04-08');
...
(1, 'Beginner Strength Training', 'A basic strength training program for beginners.', 'Beginner', 'Coach', 'workout_image/1.webp'),
...
--
ALTER TABLE `attendance_gym`
  MODIFY `gym_attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `user_workout_progress`
  MODIFY `user_workout_progress_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
